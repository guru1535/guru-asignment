...
import com.example.sessionmangementandroid.databinding.ActivitySignupBinding
...
class SignupActivity : AppCompatActivity() {
    ...
    private fun signup(firstName: String, lastName: String, email: String, contact: String, password: String, confirmPassword: String) {
        ...
        Toast.makeText(applicationContext, "Account CreatedSuccessfully", Toast.LENGTH_SHORT).show()
