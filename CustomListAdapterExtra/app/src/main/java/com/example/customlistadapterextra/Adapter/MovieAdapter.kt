package com.example.customlistadapterextra.Adapter
...
import com.example.customlistadapterextra.databinding.ItemMovieLayoutBinding
...
class MovieAdapter(var context: Context , var movieList : MutableList<Movie>) : BaseAdapter() {
    ...
    override fun getView(pos: Int, view: View?, parant: ViewGroup?): View {
        binding = ItemMovieLayoutBinding.inflate(LayoutInflater.from(context) , parant , false)
