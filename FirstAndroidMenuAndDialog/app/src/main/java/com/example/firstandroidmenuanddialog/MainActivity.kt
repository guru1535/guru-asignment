...
class MainActivity : AppCompatActivity() {
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        return when (item.itemId) {
            R.id.action_search -> {
                Toast.makeText(applicationContext, " Search item selected", Toast.LENGTH_SHORT)
                    .show()
                true
            }
            R.id.action_settings -> {
                Toast.makeText(applicationContext, "Settind item selected", Toast.LENGTH_SHORT)
                    .show()
                true
            }
            R.id.action_logout -> {
                Toast.makeText(applicationContext, "Logout item selected", Toast.LENGTH_SHORT)
                    .show()
                true
            }
    ...
    override fun onContextItemSelected(item: MenuItem): Boolean {
        return when (item.itemId) {
            ...
            R.id.action_settings -> {
                Toast.makeText(applicationContext , "Context Settings iem selected" , Toast.LENGTH_SHORT).show()
                true
            }
            R.id.action_logout -> {
